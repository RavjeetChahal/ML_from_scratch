...
from ml_from_scratch.neighbors.knn_regressor import KNeighborsRegressorScratch
...
scratch_model = KNeighborsRegressorScratch(n_neighbors=5)
...
print(f"{'Scratch KNN Regressor':<{width}} | {'Sklearn KNN Regressor':<{width}}")
print("-" * 90)
